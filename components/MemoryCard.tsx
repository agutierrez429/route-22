...
export default function MemoryCard({ memory }: MemoryCardProps) {
  return (
    <article className="overflow-hidden rounded-[2rem] border border-white/70 bg-white/85 shadow-xl backdrop-blur-md transition hover:-translate-y-1 hover:shadow-2xl">
